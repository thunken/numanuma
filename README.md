...
To add a dependency on this project using Gradle, Maven, sbt, or Leiningen, we recommend using [JitPack](https://jitpack.io/#thunken/numanuma/1.1.0). The Maven group ID is `com.github.thunken`, and the artifact ID is `numanuma`.
